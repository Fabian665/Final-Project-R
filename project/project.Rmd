...
ggplot(filtered_high_schools, aes(x = hatamot_no_ivchun + hatamot_ivchun, y = math_5_reg_ed)) +
  geom_point() +
  labs(x = "Academic Leniencies", y = "5 Points Math Entitlement") +
  theme_minimal()
```
...
ggplot(filtered_data, aes(x = year, y = math_5_reg_ed, color = muni_name, group = muni_name)) +
  geom_line(size = 1) +
  labs(x = "Year", y = "5 Points Math Entitlement", color = "Municipality") +
  theme_minimal() +
  theme(legend.position = "right")
...
ggplot(filtered_data, aes(x = year, y = masters_or_higher_in_high_school, color = muni_name, group = muni_name)) +
  geom_line(size = 1) +
  labs(x = "Year", y = "Masters Or Higher Teachers In High School", color = "Municipality") +
  theme_minimal() +
  theme(legend.position = "right")
...
ggplot(filtered_data, aes(x = year, y = sum_hatamot, color = muni_name, group = muni_name)) +
  geom_line(size = 1) +
  labs(x = "Year", y = "Academic Leniencies", color = "Municipality") +
  theme_minimal() +
  theme(legend.position = "right")
...
schools_filtered <- schools_edu_image %>%
...
average_by_pentile <- schools_filtered %>%
...
plot1 <- ggplot(average_by_pentile, aes(pentile_high, average_masters)) +
  geom_bar(stat = "identity", fill = "#00BFC4") +
  labs(x = "Pentile", y = "Masters or Higher (%)", title = "Average Masters or Higher by Pentile (2018-2021)") +
  theme_minimal() +
  theme(plot.title = element_text(size = 8)) +
  scale_y_continuous(labels = function(x) x * 100)

# Filter data from municipal_edu_image for years 2020-2021 and remove rows with missing values
municipal_filtered <- municipal_edu_image %>%
  filter(year >= 2018 & year <= 2021 & !is.na(socio_economic_status) & !is.na(masters_or_higher_in_high_school))

# Convert masters_or_higher_in_high_school to numeric
municipal_filtered$masters_or_higher_in_high_school <- as.numeric(municipal_filtered$masters_or_higher_in_high_school)

# Calculate the average masters_or_higher_in_high_school by socio_economic_status from municipal_filtered
average_by_socio_economic <- municipal_filtered %>%
...
plot2 <- ggplot(average_by_socio_economic, aes(socio_economic_status, average_masters)) +
  ...
  labs(x = "Socio-economic Status", y = "Masters or Higher (%)", title = "Average Masters or Higher by Socio-economic Status (2018-2021)") +
  theme_minimal() +
